...
public class AppConstance {
    ...
    public static final String BASE1 = "http://api.k780.com:88/?app=finance.rate_curlist";
    public static final String BASE2 = "http://api.k780.com:88/?app=finance.rate_history";
    ...
    public static final String STATUE = "ALREADY";
}
